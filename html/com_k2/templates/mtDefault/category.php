...
<section id="k2Container" class="itemListView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemListCategoriesBlock">
		...
		<div class="itemListCategory">
			...
			<details class="catItemDescription"><?php echo $this->category->description; ?></details>
			<?php endif; ?>
		...
		<div class="itemListSubCategories">
			...
			<div class="subCategoryContainer" style="width:<?php echo number_format(100/$this->params->get('subCatColumns'), 1); ?>%;">
				<div class="subCategory">
					...
					<details class="subCategoryDescription"><?php echo $subCategory->description; ?></details>
					<?php endif; ?>
