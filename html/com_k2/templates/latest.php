...
<section id="k2Container" class="latestView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<?php if($this->source=='categories'): $category=$block; ?>
		...
		<div class="latestItemsCategory">
			...
			<details class="latestItemsCategoryDescription"><?php echo $category->description; ?></details>
			<?php endif; ?>
	...
	<?php else: $user=$block; ?>
		...
		<div class="latestItemsUser">
			...
			<details class="latestItemsUserDescription"><?php echo $user->profile->description; ?></details>
			<?php endif; ?>
