...
<?php echo $this->article->event->beforeDisplayContent; ?>
	...
	<time class="created_date" datetime="<?php echo JHTML::_('date', $this->article->created, '%Y-%m-%d %H:%M') ?>">
	...
	<time class="modified_date" datetime="<?php echo JHTML::_('date', $this->article->modified, '%Y-%m-%d %H:%M'); ?>">
